...
Few other experiments were conducted by adding varied number (50, 100, 150, 200, 250) of in-situ background images (without real-world objects), and we observed that the NST Model performs better than Baseline Model as more in-situ data is added.
