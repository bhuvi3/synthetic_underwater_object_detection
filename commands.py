...
# Failed due to improper renders. Also found that for insite-50, it gave very less AUC: 34%.
# Next try including the images from previous network, and start from scratch instead of pre-trained weights from synthetic backgrounds then train for full 15000 steps.
